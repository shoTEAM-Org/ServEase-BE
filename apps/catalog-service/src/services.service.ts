...
export class ServicesService {
  ...
  getMockServices() {
    return { success: true, data: serviceDetails };
  }
    ...
    try {
      let query = supabase
        ...
        .select(`
          ...
          provider_profiles!inner (user_id, business_name, trust_score, verification_status)
        `)
      ...
      return { status: 200, message: 'Search successful', results: sortedResults };
    } catch (err) {
