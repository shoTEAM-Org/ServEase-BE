...
export class ProviderCounterOfferDto {
  @IsDateString(
    {},
    { message: 'Proposed date and time must be a valid ISO string.' },
  )
  scheduled_at: string;
  ...
  @IsNumber(
    {},
    { message: 'Estimated duration must be a valid number (hours).' },
  )
  ...
  @IsNumber()
  @IsIn([24, 48, 72], {
    message: 'Validity period must be 24, 48, or 72 hours.',
  })
