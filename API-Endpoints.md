...
| GET    | `/api/booking/v1/:id/status`        | Yes  | Get current booking status and timeline                                                 |
| PATCH  | `/api/booking/v1/:id/status`        | Yes  | Update booking status **(async)**                                                       |
| PATCH  | `/api/booking/v1/:id/provider-done` | Yes  | Provider marks service done; status remains `in_progress`                               |
| PATCH  | `/api/booking/v1/:id/customer-done` | Yes  | Customer confirms completion; requires provider done timestamp, then status becomes `completed` |
...
| PATCH  | `/api/provider/v1/booking/:id/provider-done` | Yes  | Provider marks assigned service done; status remains `in_progress`   |
| PATCH  | `/api/provider/v1/booking/:id/done`          | Yes  | Alias for provider completion                                        |
...
```json
{
  ...
  "reject_reason": "required if rejected",
  "admin_id": "optional"
}
```
...
| Method | Path                                              | Auth | Description                                                  |
| ------ | ------------------------------------------------- | ---- | ------------------------------------------------------------ |
| GET    | `/api/admin/v1/finance/transactions?page=&limit=` | Yes  | Paginated transaction history with customer/provider context |
...
| Method | Path                                                | Auth | Description                                      |
| ------ | --------------------------------------------------- | ---- | ------------------------------------------------ |
| GET    | `/api/admin/v1/marketplace/categories?page=&limit=` | Yes  | Paginated category list for admin management     |
